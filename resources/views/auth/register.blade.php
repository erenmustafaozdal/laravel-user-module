...
@section('content')
    {!! Form::open([
        ...
        <h3 class="form-title font-green">{!! trans('laravel-user-module::auth.register.title') !!}</h3>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">
                <span>{!! trans('laravel-user-module::auth.register.first_name') !!}</span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">
                <span>{!! trans('laravel-user-module::auth.register.last_name') !!}</span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">
                <span>{!! trans('laravel-user-module::auth.register.email') !!}</span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">
                <span>{!! trans('laravel-user-module::auth.register.password') !!}</span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">
                <span>{!! trans('laravel-user-module::auth.register.password_confirmation') !!}</span>
            </label>
        ...
        <div class="form-group margin-top-20 margin-bottom-20">
            <label class="check">
                {!! Form::checkbox('terms') !!}
                {!! trans('laravel-user-module::auth.register.terms_content') !!}
            </label>
            <div id="register_tnc_error"> </div>
        </div>
        <div class="form-actions">
            <a href="{!! route('getLogin') !!}" class="btn btn-default">
                <span>{!! trans('laravel-user-module::auth.register.login') !!}</span>
            </a>
