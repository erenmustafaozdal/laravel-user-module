...
@section('content')
    {!! Form::open([
        ...
        <h3 class="form-title font-green">{!! trans('laravel-user-module::auth.reset_password.title') !!}</h3>
        <p>{!! trans('laravel-user-module::auth.reset_password.message') !!}</p>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">
                <span>{!! trans('laravel-user-module::auth.reset_password.email') !!}</span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">
                <span>{!! trans('laravel-user-module::auth.reset_password.password') !!}</span>
            </label>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">
                <span>{!! trans('laravel-user-module::auth.reset_password.password_confirmation') !!}</span>
            </label>
        ...
        <div class="form-actions">
            <a href="{!! route('getLogin') !!}" class="btn btn-default">
                <span>{!! trans('laravel-user-module::auth.reset_password.login') !!}</span>
            </a>
