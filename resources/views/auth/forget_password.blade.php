...
@section('content')
    {!! Form::open([
        ...
        <h3 class="form-title font-green">{!! trans('laravel-user-module::auth.forget_password.title') !!}</h3>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">
                <span>{!! trans('laravel-user-module::auth.forget_password.email') !!}</span>
            </label>
        ...
        <div class="form-actions">
            <a href="{!! route('getLogin') !!}" class="btn btn-default">
                <span>{!! trans('laravel-user-module::auth.forget_password.login') !!}</span>
            </a>
