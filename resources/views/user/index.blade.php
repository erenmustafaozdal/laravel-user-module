                ...
                <table class="table table-striped table-bordered table-hover table-checkable lmcDataTable">
                    <thead>
                        <tr role="row" class="heading">
                            ...
                            <th width="100"> {!! trans('laravel-user-module::admin.fields.user.last_name') !!} </th>
                            <th width="200"> {!! trans('laravel-user-module::admin.fields.user.email') !!} </th>
                            <th width="10%"> {!! trans('laravel-user-module::admin.fields.user.status') !!} </th>
                            <th width="15%"> {!! trans('laravel-user-module::admin.fields.user.last_login') !!} </th>
                            <th width="15%"> {!! trans('laravel-user-module::admin.fields.user.created_at') !!} </th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td> </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="first_name" placeholder="{!! trans('laravel-user-module::admin.fields.user.first_name') !!}">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="last_name" placeholder="{!! trans('laravel-user-module::admin.fields.user.last_name') !!}">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="email" placeholder="{!! trans('laravel-user-module::admin.fields.user.email') !!}">
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="input-group date date-picker margin-bottom-5" data-date-format="dd/mm/yyyy">
                                    <input type="text" class="form-control form-filter input-sm" readonly name="last_login_from" placeholder="{!! trans('laravel-user-module::admin.ops.date_from') !!}">
                                ...
                                <div class="input-group date date-picker" data-date-format="dd/mm/yyyy">
                                    <input type="text" class="form-control form-filter input-sm" readonly name="last_login_to" placeholder="{!! trans('laravel-user-module::admin.ops.date_to') !!}">
                                    <span class="input-group-btn">
                                        <button class="btn btn-sm default" type="button">
                                            <i class="fa fa-calendar"></i>
                                        </button>
